...
mixin _$AppParamsResponseState {
  ...
  bool get investInfoDisplayFlag => throw _privateConstructorUsedError;
...
class _$AppParamsResponseStateCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    Object? investInfoDisplayFlag = null,
  }) {
    return _then(_value.copyWith(
      ...
      sameMonthIncomeDeleteFlag: null == sameMonthIncomeDeleteFlag
          ...
          : sameMonthIncomeDeleteFlag // ignore: cast_nullable_to_non_nullable
              as bool,
      investInfoDisplayFlag: null == investInfoDisplayFlag
          ? _value.investInfoDisplayFlag
          : investInfoDisplayFlag // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$AppParamsResponseStateImpl implements _AppParamsResponseState {
  const _$AppParamsResponseStateImpl(
      ...
      this.investInfoDisplayFlag = false});
  ...
  @override
  @JsonKey()
  final bool investInfoDisplayFlag;

  @override
  String toString() {
    return 'AppParamsResponseState(calendarSelectedDate: $calendarSelectedDate, menuNumber: $menuNumber, selectedIncomeYear: $selectedIncomeYear, sameMonthIncomeDeleteFlag: $sameMonthIncomeDeleteFlag, investInfoDisplayFlag: $investInfoDisplayFlag)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.investInfoDisplayFlag, investInfoDisplayFlag) ||
                other.investInfoDisplayFlag == investInfoDisplayFlag));
  }

  @override
  int get hashCode => Object.hash(runtimeType, calendarSelectedDate, menuNumber,
      selectedIncomeYear, sameMonthIncomeDeleteFlag, investInfoDisplayFlag);
...
abstract class _AppParamsResponseState implements AppParamsResponseState {
  const factory _AppParamsResponseState(
      ...
      final String selectedIncomeYear,
      final bool sameMonthIncomeDeleteFlag,
      final bool investInfoDisplayFlag}) = _$AppParamsResponseStateImpl;
  ...
  @override
  bool get investInfoDisplayFlag;
  @override
  @JsonKey(ignore: true)
  _$$AppParamsResponseStateImplCopyWith<_$AppParamsResponseStateImpl>
