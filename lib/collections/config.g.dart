...
const ConfigSchema = CollectionSchema(
  ...
  idName: r'id',
  indexes: {
    r'configKey': IndexSchema(
      id: 148847106925441600,
      name: r'configKey',
      unique: false,
      replace: false,
      properties: [
...
extension ConfigQueryWhere on QueryBuilder<Config, Config, QWhereClause> {
  ...
  QueryBuilder<Config, Config, QAfterWhereClause> configKeyEqualTo(
      String configKey) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'configKey',
        value: [configKey],
      ));
    });
  }

  QueryBuilder<Config, Config, QAfterWhereClause> configKeyNotEqualTo(
      String configKey) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
